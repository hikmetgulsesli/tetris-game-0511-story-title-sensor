...
export function GameOptions({ actions }: GameOptionsProps) {
  return (
    <>
      ...
      <input className="w-full h-1 bg-surface-variant rounded-none appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background" id="master-volume" max="100" min="0" type="range" value="80" />
      <Circle className="text-on-surface-variant text-[18px]" aria-hidden={true} focusable="false" />
      </div>
      </div>
      <div className="flex justify-between items-center group">
      ...
      <div className="w-1/2 flex items-center gap-3">
      <Circle className="text-on-surface-variant text-[18px]" aria-hidden={true} focusable="false" />
      <input className="w-full h-1 bg-surface-variant rounded-none appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background" id="sfx-volume" max="100" min="0" type="range" value="100" />
      <Circle className="text-on-surface-variant text-[18px]" aria-hidden={true} focusable="false" />
      </div>
      </div>
      ...
      <label className="relative cursor-pointer min-h-[44px] block focus-ring">
      <input checked={true} className="peer sr-only" name="difficulty" type="radio" value="normal" />
      <div className="h-full flex flex-col items-center justify-center p-4 bg-surface machined-border peer-checked:bg-surface-variant peer-checked:border-primary peer-checked:text-primary text-on-surface-variant hover:bg-surface-container-high transition-colors">
      ...
      <input className="w-full h-1 bg-surface-variant rounded-none appearance-none cursor-pointer mt-2 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background" id="das" max="300" min="50" type="range" value="133" />
      ...
      <input className="w-full h-1 bg-surface-variant rounded-none appearance-none cursor-pointer mt-2 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background" id="arr" max="50" min="0" type="range" value="10" />
      <div className="flex justify-between text-label-sm font-label-sm text-on-surface-variant mt-1">
      <span>Instant</span>
      <span>Laggy</span>
      </div>
      ...
      <button className="min-h-[44px] bg-primary text-on-primary text-label-md font-label-md uppercase tracking-widest hover:bg-surface-tint transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background active:scale-[0.98]" type="button" data-action-id="save-configuration-4" onClick={actions?.["save-configuration-4"]}>
                          Save Configuration
                      </button>
      <button className="min-h-[44px] bg-surface text-on-background border border-outline-variant hover:bg-surface-variant hover:text-primary transition-colors text-label-md font-label-md uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background active:scale-[0.98]" type="button" data-action-id="revert-defaults-5" onClick={actions?.["revert-defaults-5"]}>
                          Revert Defaults
                      </button>
