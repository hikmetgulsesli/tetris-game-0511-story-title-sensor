...
export function GameOver({ actions }: GameOverProps) {
  return (
    <>
      ...
      <div className="text-headline-lg font-headline-lg text-primary">24</div>
      </div>
      <div className="bg-surface-container-low border border-surface-variant p-4 text-center">
      <h3 className="text-label-sm font-label-sm text-on-surface-variant uppercase tracking-widest mb-2">Lines Cleared</h3>
      <div className="text-headline-lg font-headline-lg text-primary">248</div>
      </div>
      </div>
      </div>
      </div>
      ...
      <Circle  data-icon="replay" data-weight="fill" style={{fontVariationSettings: "'FILL' 1"}} aria-hidden={true} focusable="false" />
