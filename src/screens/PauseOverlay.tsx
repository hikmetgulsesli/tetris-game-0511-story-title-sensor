...
export function PauseOverlay({ actions }: PauseOverlayProps) {
  return (
    <>
      ...
      <Circle  data-weight="fill" className="text-[64px] text-primary" aria-hidden={true} focusable="false" />
      ...
      <p className="font-label-md text-label-md text-on-surface-variant uppercase tracking-[0.2em] text-center mt-2">
                          Current Score: <span className="text-primary font-bold">042,100</span>
      </p>
      </div>
      {/* Divider */}
      ...
      <Circle  data-icon="exit_to_app" className="text-on-surface group-hover:text-primary transition-colors" aria-hidden={true} focusable="false" />
      <span>Main Menu</span>
      </button>
      </div>
      </section>
      ...
      <Circle  data-icon="keyboard" className="text-[16px]" aria-hidden={true} focusable="false" />
