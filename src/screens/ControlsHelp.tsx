...
export function ControlsHelp(_props: ControlsHelpProps) {
  return (
    <>
      ...
      <Circle className="text-primary dark:text-primary active:scale-95 transition-transform duration-100 cursor-pointer" aria-hidden={true} focusable="false" />
      ...
      <a className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary hover:bg-surface-container-highest transition-colors duration-200 h-full flex items-center px-4 font-label-md text-label-md" href="#">Battle</a>
      <a className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary hover:bg-surface-container-highest transition-colors duration-200 h-full flex items-center px-4 font-label-md text-label-md" href="#">Ranks</a>
      <a className="text-primary border-b-2 border-primary pb-1 hover:bg-surface-container-highest transition-colors duration-200 h-full flex items-center px-4 font-label-md text-label-md" href="#">Controls</a>
      <a className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary hover:bg-surface-container-highest transition-colors duration-200 h-full flex items-center px-4 font-label-md text-label-md" href="#">Account</a>
      </nav>
      <div className="flex items-center gap-4">
      <Circle className="text-primary dark:text-primary active:scale-95 transition-transform duration-100 hover:text-primary hover:bg-surface-container-highest transition-colors duration-200 cursor-pointer" aria-hidden={true} focusable="false" />
      ...
      <Circle aria-hidden={true} focusable="false" /> Keyboard
                          </h3>
      ...
      <div className="col-start-2 w-10 h-10 bg-surface-container-highest border border-outline-variant rounded-sm flex items-center justify-center text-primary"><Circle aria-hidden={true} focusable="false" /></div>
      ...
      <div className="row-start-3 col-start-2 w-10 h-10 bg-surface-container-highest border border-outline-variant rounded-sm flex items-center justify-center text-primary"><Circle aria-hidden={true} focusable="false" /></div>
      </div>
      ...
      <a className="flex flex-col items-center justify-center text-on-primary bg-primary rounded-none w-full h-full border-t-2 border-primary active:opacity-80 transition-opacity duration-100" href="#">
      <Circle  style={{fontVariationSettings: "'FILL' 1"}} aria-hidden={true} focusable="false" />
